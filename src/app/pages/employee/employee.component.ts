      ...
      @if (showForm) {
        <form class="card form-card" (ngSubmit)="save()">
          <div class="form-header">
            <h3>{{ editingId ? 'Edit Employee' : 'Create New Employee' }}</h3>
        ...
        <div class="card table-card">
          <div class="table-header">
            ...
            <div class="table-header-actions">
              ...
              <button
                ...
                class="btn-primary"
                (click)="toggleForm()"
                *appHasPermission="Permissions.EMPLOYEE.CREATE"
              >
          ...
          @if (items().length === 0) {
            <div class="empty-state">
              ...
              <p>Get started by creating your first employee record.</p>
            </div>
          } @else {
                ...
                <thead>
                  <tr>
                    ...
                    <th
                      *appHasPermission="{
                        mode: 'any',
                        permissions: [Permissions.EMPLOYEE.UPDATE, Permissions.EMPLOYEE.DELETE],
                      }"
                    >
                      Actions
                    </th>
                      ...
                      <td>
                        <div class="action-buttons">
                          <button
                            ...
                            (click)="edit(item)"
                            *appHasPermission="Permissions.EMPLOYEE.UPDATE"
                            title="Edit"
                          >
                            <span>Edit</span>
                          </button>
                          <button
                            ...
                            *appHasPermission="Permissions.EMPLOYEE.DELETE"
                            title="Delete"
                          >
                            <span>Delete</span>
                          </button>
...
export class EmployeeComponent {
  ...
  readonly items = signal(this.runtimeData.getItems('employee'));
  showForm = false;
  ...
  save(): void {
    if (this.editingId) {
      this.items.set(
        this.runtimeData.updateItem('employee', {
          id: this.editingId,
          name: this.form.name,
      ...
      this.items.set(
        this.runtimeData.createItem('employee', {
          id: `E-${Date.now()}`,
          name: this.form.name,
          description: this.form.description,
          createdAt: new Date().toISOString(),
  ...
  remove(id: string): void {
    this.items.set(this.runtimeData.deleteItem('employee', id));
  }
}

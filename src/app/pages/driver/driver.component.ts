    ...
    <div class="page">
      ...
      <section class="hero-card">
        ...
        <div class="hero-content">
          ...
          <p class="subtitle">Manage driver records and details</p>
        </div>
        <div class="hero-badge">
          <div class="badge-inner">DM</div>
        ...
        <form class="card form-card" (ngSubmit)="save()">
          ...
          <div class="form-footer">
            ...
            <button type="submit" class="btn-submit">
              <span>{{ editingId ? 'Update Driver' : 'Create Driver' }}</span>
            </button>
          </div>
        </form>
      } @else {
        <div class="card table-card">
          <div class="table-header">
            ...
            <div class="table-header-actions">
              ...
              <button
                ...
                class="btn-primary"
                (click)="toggleForm()"
                *appHasPermission="Permissions.DRIVER.CREATE"
              >
          ...
          @if (items().length === 0) {
            <div class="empty-state">
              ...
              <p>Get started by creating your first driver record.</p>
            </div>
          } @else {
                ...
                <thead>
                  <tr>
                    ...
                    <th
                      *appHasPermission="{
                        mode: 'any',
                        permissions: [Permissions.DRIVER.UPDATE, Permissions.DRIVER.DELETE],
                      }"
                    >
                      Actions
                    </th>
                      ...
                      <td>
                        <div class="action-buttons">
                          <button
                            ...
                            (click)="edit(item)"
                            *appHasPermission="Permissions.DRIVER.UPDATE"
                            title="Edit"
                          >
                            <span>Edit</span>
                          </button>
                          <button
                            ...
                            *appHasPermission="Permissions.DRIVER.DELETE"
                            title="Delete"
                          >
                            <span>Delete</span>
                          </button>
...
export class DriverComponent {
  ...
  readonly items = signal(this.runtimeData.getItems('driver'));
  showForm = false;
  ...
  save(): void {
    if (this.editingId) {
      this.items.set(
        this.runtimeData.updateItem('driver', {
          id: this.editingId,
          name: this.form.name,
      ...
      this.items.set(
        this.runtimeData.createItem('driver', {
          id: `D-${Date.now()}`,
          name: this.form.name,
          description: this.form.description,
          createdAt: new Date().toISOString(),
  ...
  remove(id: string): void {
    this.items.set(this.runtimeData.deleteItem('driver', id));
  }
}
